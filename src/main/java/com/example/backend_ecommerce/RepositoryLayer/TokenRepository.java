...
public interface TokenRepository extends JpaRepository<TokenTable,BigInteger>{
    ...
    @Modifying
    @Query(value = "DELETE FROM token_table where token_table.token_value = :token_value",nativeQuery = true)
    public void deleteToken(@Param("token_value") String token_value);
